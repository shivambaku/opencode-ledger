...
export const ledgerActionConfigs = [
  ...
  { action: "nextFile", command: "ledger.nextFile", commandKey: "]", desc: "Next file", keys: ["]", "rightbracket"] },
  { action: "prevFile", command: "ledger.prevFile", commandKey: "[", desc: "Previous file", keys: ["[", "leftbracket"] },
  ...
  { action: "toggleMode", command: "ledger.toggleMode", commandKey: "b", desc: "Toggle branch + local / uncommitted only", keys: ["b"] },
  { action: "chooseBase", command: "ledger.chooseBase", commandKey: "shift+b", desc: "Choose comparison base", keys: ["shift+b"], aliases: ["B"] },
  ...
  { action: "prevBlock", command: "ledger.prevBlock", commandKey: "shift+k", desc: "Previous block", keys: ["shift+k", "shift+n"], aliases: ["K", "N"] },
  { action: "nextBlock", command: "ledger.nextBlock", commandKey: "shift+j", desc: "Next block", keys: ["shift+j", "n"], aliases: ["J"] },
